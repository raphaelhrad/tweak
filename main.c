...
int main(int argc, char* argv[])
{
    ...
    if ( pSpriteTourSol )  //si le permier sprite a bien été chargé, on suppose que les autres aussi
    {
        ...
        message("Welcome in TowerDefend","Ceci est un point de depart pour votre future interface de votre jeu TowerDefend");
        ...
        while ( cont != 0 ){   //VOUS DEVEZ GERER (DETECTER) LA FIN DU JEU -> tourRoiDetruite
                ...
                //a supprimer, c'est juste pour attirer votre attention sur comment est géré le chemin (un tableau 2D de coordonnées)(regarder le corps de afficheCoordonneesParcours)
